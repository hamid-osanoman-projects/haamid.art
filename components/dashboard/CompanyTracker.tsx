...
export default function CompanyTracker({ initialTasks }: CompanyTrackerProps) {
  ...
  const renderMarkdown = (text: string = '') => {
    let html = text
      ...
      .replace(/\*(.*)\*/gim, '<em>$1</em>')
      .replace(/`(.*?)`/gim, '<code class="bg-zinc-800 px-1 py-0.5 rounded text-xs text-purple-400 font-mono">$1</code>')
      ...
      <div className="flex flex-col sm:flex-row items-center justify-between gap-4 mb-6 border-b border-[#e5e5e5] dark:border-[#262626] pb-4 bg-white dark:bg-[#0d0d0d] z-10">
        ...
        <div className="relative w-full sm:w-64">
          ...
          <input
            ...
            className="w-full rounded-xl border border-zinc-200 dark:border-zinc-800 bg-zinc-50 dark:bg-zinc-900/60 py-2 pr-4 pl-10 text-xs text-zinc-800 dark:text-zinc-100 outline-none transition-all focus:border-purple-500/50 focus:bg-white dark:focus:bg-zinc-900"
          />
        </div>
              ...
              <div className="flex-1 overflow-y-auto space-y-3 pr-1 min-h-[150px]">
                {statusTasks.map(task => (
                  <div
                    ...
                    className="group flex flex-col p-4 rounded-xl border border-zinc-200 dark:border-zinc-800 bg-zinc-50/50 dark:bg-[#0d0d0d] hover:border-purple-500/30 hover:bg-white dark:hover:bg-[#111] transition-all cursor-grab active:cursor-grabbing shadow-sm"
                  >
                    {/* Header badge */}
                    <div className="flex items-start justify-between gap-2 mb-2">
                      <h4 className="text-xs font-bold text-zinc-800 dark:text-zinc-100 leading-tight group-hover:text-purple-400 transition-colors">
                        {task.title}
                      </h4>
                    </div>
              ...
              <div className="mt-3 border-t border-zinc-100 dark:border-zinc-800/80 pt-3">
                <div className="flex gap-2">
                  ...
                  <button 
                    ...
                    className="p-1 rounded bg-purple-500/10 text-purple-400 hover:bg-purple-600 hover:text-white transition-colors disabled:opacity-30 disabled:pointer-events-none cursor-pointer"
                  >
            ...
            <div className="mb-6 space-y-2">
                ...
                <div className="flex gap-2">
                  <button
                    ...
                    className={`text-[9px] font-bold uppercase tracking-wider px-2 py-0.5 rounded ${
                      activeDetailTab === 'edit' ? 'bg-purple-500/10 text-purple-400' : 'text-zinc-400'
                    }`}
                  >
                    Edit
                  </button>
                  <button
                    ...
                    className={`text-[9px] font-bold uppercase tracking-wider px-2 py-0.5 rounded ${
                      activeDetailTab === 'preview' ? 'bg-purple-500/10 text-purple-400' : 'text-zinc-400'
                    }`}
                  >
                    Preview
                  </button>
              ...
              {activeDetailTab === 'edit' ? (
                <textarea
                  ...
                  className="w-full rounded-xl border border-zinc-200 dark:border-zinc-800 bg-transparent py-3 px-4 text-xs text-zinc-800 dark:text-zinc-100 placeholder-zinc-500 outline-none transition-all focus:border-purple-500/40"
                />
              ) : (
                <div 
